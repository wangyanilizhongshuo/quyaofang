		...
		<!-- <view class="search-box" > -->
			...
			<view class="input-box">
				...
				<view class="right" @tap="pointSearch">
					...
					<input class="input" placeholder="请输入您想找的房子" v-model="searchKey" @confirm="getInputSerach"  placeholder-style="color:#959BA7;font-size:24rpx;"/>
				</view>
			</view>
			<!--  -->
		</view>
			...
			<view class="box-list" v-for="(item,index) in  houseList" :key="index" @tap="jumpDetail(item.id)">
				...
				<view class="right">
					...
					<view class="fourth-line">
						<text class="lists" v-for="(items,indexs) in item.r_facility" :key="index">{{items}}</text>
					</view>
